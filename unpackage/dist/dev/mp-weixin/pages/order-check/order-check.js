...
var _permission = _interopRequireDefault(__webpack_require__(/*! @/common/lib/permission.js */ 102));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var _default =
    ...
    scan: function () {var _scan = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _this = this;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                uni.scanCode({
                  success: function success(res) {
                    // this.ordersn = val
                    _this.ordersn = res.result;
                    console.log('this.ordersn:', _this.ordersn);
                  },
...
var _orderCheck = _interopRequireDefault(__webpack_require__(/*! ./pages/order-check/order-check.vue */ 97));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _order_check_vue_vue_type_template_id_ca6f90a0___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./order-check.vue?vue&type=template&id=ca6f90a0& */ 98);
/* harmony import */ var _order_check_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./order-check.vue?vue&type=script&lang=js& */ 100);
