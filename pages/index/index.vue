<template>
	<view>
		...
		<view class="position-absolute w-700 mx-25 mt-2">
			...
			<view class="bg-white shadow-nom rounded-12 d-flex j-sb a-center mb-2" style="height: 98rpx;" @click="$navigate('earn-search')">
				<view class="d-flex a-center text-black font-32 ml-2">
			...
			<view class="bg-white shadow-nom rounded-12 d-flex j-sb a-center mb-2" style="height: 98rpx;" @click="$navigate('deal-order')">
				<view class="d-flex a-center text-black font-32 ml-2">
