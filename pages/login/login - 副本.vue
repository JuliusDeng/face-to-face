	...
	<view class="h-vh100 position-relative">
		<view class="d-flex j-center a-center">
			<view class="d-flex border-bottom a-center" style="width: 550rpx;height: 130rpx;margin-top: 150rpx;">
				...
				<input type="text" placeholder="请输入手机号" class="ml-3 text-ab text-black font-30 d-flex a-center" :class="focusClass.phone ? 'input-border-color' : ''" 
				v-model="phone" maxlength="11" @focus="focus('phone')" @blur="blur('phone')"/>
			</view>
		</view>
		...
		<!-- <view class="d-flex a-center">
			<view class="d-flex border-bottom a-center j-sb" style="width: 550rpx;height: 130rpx;">
				<view class="d-flex a-center">
					...
					<input type="text" placeholder="请输入验证码" class="ml-3 text-ab text-black font-30 d-flex a-center" :class="focusClass.captcha ? 'input-border-color' : ''" 
					v-model="captcha" maxlength=4 @focus="focus('captcha')" @blur="blur('captcha')"/>
				</view>
				...
				<text class="input-box a-center j-center main-text-color" @click="!safety.state ? getCode() : ''">
